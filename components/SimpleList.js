...
const simpleData = [
  ...
  {id:4, title:"incididunt ut labore et dolore magna aliqua"},
]
...
const SimpleList = () => {
  ...
  // 감지할 변수 값이 바뀔 때마다 함수가 다시 생성되게 함.
    ...
    >
      {/* JSX Element에 코드를 삽입하려면 {} 중괄호를 삽입 */}
      {
        ...
        simpleData.map(data =>{
          return(
            // 터치가 가능한 투명한 영역
            <TouchableOpacity key={data.id} onPress={()=>{/*console.log(data); setItem(data)*/ itemPressed(data)}}>
